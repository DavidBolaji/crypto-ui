            ...
            >
                <Flex justify="start" flexWrap="wrap" alignItems="start">
                    <Box w={{ base: "100%", lg: 1 / 4 }} mb={{ base: "1.5rem", lg: "0" }}>
                        ...
                        <List lineHeight="2">
                            <LinkItem text="All NFTs" />
                            <LinkItem text="Hip Hop" />
                            <LinkItem text="R&B & Soul" />
                            <LinkItem text="Rap" />
                            <LinkItem text="Gospel" />
                        </List>
                    </Box>
                    <Box w={{ base: "100%", lg: 1 / 4 }} mb={{ base: "1.5rem", lg: "0" }}>
                        <Heading
                        ...
                        <List lineHeight="2">
                            <LinkItem text="Profile" />
                            <LinkItem text="Favorite" />
                            <LinkItem text="Watch List" />
                            <LinkItem text="My Collections" />
                            <LinkItem text="Settings" />
